...
**World Racing Group** — Web Developer (2025–Present)
Maintaining WordPress sites, custom plugins, and MariaDB queries that power live race results, standings, and streaming content for World of Outlaws, DIRTcar, and DIRTVision. Troubleshooting third-party API integrations and contributing to internal race-day tools.
...
**Hybrid Hiring Solutions — Production Platform (Externship)** · TypeScript · React 18 · Meteor · MongoDB
- Real-time data sync via Meteor's DDP/WebSockets layer, domain-driven APIs, and validated write operations
- Full Agile lifecycle via Jira-integrated Git workflows (tickets → PRs → review → testing)
...
**Languages** TypeScript · JavaScript (ES2022+) · Python · PHP · SQL · HTML5 · CSS3
...
**AI & APIs** Claude API · OpenAI APIs · RAG · LLM Integration · Groq API · Llama 3.3 70B · PDF.js
**Tools** Git · GitHub Actions · CI/CD · AWS · Jira · Vercel · Netlify · GitHub Pages · WordPress
